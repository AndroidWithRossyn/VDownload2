...
import static com.fastdownload.wallpaper.livetoolsexplore.utils.Utils.ROOTDIRECTORYMITRON;
...
public class MitronActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(MitronActivity.this).loadInterstitialAd(this);
        AppManage.getInstance(MitronActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);
        createFileFolder();
        initViews();
    ...
    private void initViews() {
        ...
        binding.imBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AppManage.getInstance(MitronActivity.this).showInterstitialAd(MitronActivity.this, new AppManage.MyCallback() {
                    public void callbackCall() {
                        Intent intent = new Intent(MitronActivity.this, StatusSaverOfAllAppActivity.class);
