...
import com.fastdownload.wallpaper.livetoolsexplore.databinding.ActivityLoginBinding;
...
public class FBLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        android.graphics.drawable.Drawable background = FBLoginActivity.this.getResources().getDrawable(R.drawable.gradient_theme);
