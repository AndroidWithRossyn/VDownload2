...
import static com.fastdownload.wallpaper.livetoolsexplore.utils.Utils.ROOTDIRECTORYJOSH;
...
public class JoshActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity = this;
        AppManage.getInstance(JoshActivity.this).loadInterstitialAd(this);
        AppManage.getInstance(JoshActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);
    ...
    private void initViews() {
        ...
        binding.imBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AppManage.getInstance(JoshActivity.this).showInterstitialAd(JoshActivity.this, new AppManage.MyCallback() {
                    public void callbackCall() {
                        Intent intent = new Intent(JoshActivity.this, StatusSaverOfAllAppActivity.class);
