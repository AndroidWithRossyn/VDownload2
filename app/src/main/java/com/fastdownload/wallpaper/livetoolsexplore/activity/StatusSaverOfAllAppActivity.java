...
import com.fastdownload.wallpaper.livetoolsexplore.SocialMediaPages.ChingariActivity;
import com.fastdownload.wallpaper.livetoolsexplore.SocialMediaPages.FacebookActivity;
import com.fastdownload.wallpaper.livetoolsexplore.SocialMediaPages.InstagramActivity;
import com.fastdownload.wallpaper.livetoolsexplore.SocialMediaPages.JoshActivity;
import com.fastdownload.wallpaper.livetoolsexplore.SocialMediaPages.LikeeActivity;
import com.fastdownload.wallpaper.livetoolsexplore.SocialMediaPages.MXTakaTakActivity;
import com.fastdownload.wallpaper.livetoolsexplore.SocialMediaPages.MitronActivity;
import com.fastdownload.wallpaper.livetoolsexplore.SocialMediaPages.MojActivity;
import com.fastdownload.wallpaper.livetoolsexplore.SocialMediaPages.ReposeActivity;
import com.fastdownload.wallpaper.livetoolsexplore.SocialMediaPages.SharechatActivity;
import com.fastdownload.wallpaper.livetoolsexplore.SocialMediaPages.SnackVideoActivity;
import com.fastdownload.wallpaper.livetoolsexplore.SocialMediaPages.TikTokActivity;
import com.fastdownload.wallpaper.livetoolsexplore.SocialMediaPages.TwitterActivity;
import com.fastdownload.wallpaper.livetoolsexplore.SocialMediaPages.WhatsappActivity;
import com.fastdownload.wallpaper.livetoolsexplore.databinding.ActivityStatusSaverOfAllAppBinding;
import com.fastdownload.wallpaper.livetoolsexplore.utils.AppLangSessionManager;
import com.fastdownload.wallpaper.livetoolsexplore.utils.ClipboardListener;
...
public class StatusSaverOfAllAppActivity extends AppCompatActivity implements View.OnClickListener {
    StatusSaverOfAllAppActivity activity;
    TextView homepage, wallpaper, saved,menu_opn;
    ImageView menu;
    LinearLayout ll1;
    ActivityStatusSaverOfAllAppBinding binding;
    ImageView back,rvWhatsApp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_status_saver_of_all_app);
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        getWindow().setStatusBarColor(Color.TRANSPARENT);
        final Animation animation = AnimationUtils.loadAnimation(this,R.anim.bounce);
        android.graphics.drawable.Drawable background = StatusSaverOfAllAppActivity.this.getResources().getDrawable(R.drawable.gradient_theme);
        getWindow().setBackgroundDrawable(background);
        activity = this;
        AppManage.getInstance(StatusSaverOfAllAppActivity.this).loadInterstitialAd(this);
        ...
        homepage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(StatusSaverOfAllAppActivity.this, StatusSaverOfAllAppActivity.class);
        ...
        wallpaper.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(StatusSaverOfAllAppActivity.this, WallActivity.class);
                overridePendingTransition(0, 0);
                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
            }
        ...
        saved.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(StatusSaverOfAllAppActivity.this, DownloadActivity.class);
                overridePendingTransition(0, 0);
                intent.setFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION);
                startActivity(intent);
            }
    ...
    private void click() {
        this.rvWhatsApp.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                AppManage.getInstance(StatusSaverOfAllAppActivity.this).showInterstitialAd(StatusSaverOfAllAppActivity.this, new AppManage.MyCallback() {
                    public void callbackCall() {
                        new Random().nextInt(3);

                        StatusSaverOfAllAppActivity.this.startActivity(new Intent(StatusSaverOfAllAppActivity.this, WhatsappActivity.class));
                    }
...
//    }
    ...
    public void showNotification(String Text) {
        if (Text.contains("instagram.com") || Text.contains("facebook.com") || Text.contains("fb") || Text.contains("tiktok.com")
            ...
            Intent intent = new Intent(activity, StatusSaverOfAllAppActivity.class);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(StatusSaverOfAllAppActivity.this, ThankuActivity.class);
        startActivity(intent);
    ...
    public void setLocale(String lang) {
        ...
        Intent refresh = new Intent(StatusSaverOfAllAppActivity.this, StatusSaverOfAllAppActivity.class);
