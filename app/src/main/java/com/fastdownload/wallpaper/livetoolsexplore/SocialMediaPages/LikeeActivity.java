...
import static com.fastdownload.wallpaper.livetoolsexplore.activity.StatusSaverOfAllAppActivity.extractLinks;
import static com.fastdownload.wallpaper.livetoolsexplore.utils.Utils.RootDirectoryLikeeShow;
...
public class LikeeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createFileFolder();
        initViews();
        AppManage.getInstance(LikeeActivity.this).loadInterstitialAd(this);
        AppManage.getInstance(LikeeActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);
        binding.imAppIcon.setImageDrawable(getResources().getDrawable(R.drawable.likee_icon));
        binding.tvAppName.setText(getResources().getString(R.string.likee_app_name));
        binding.appName.setText(getResources().getString(R.string.likee_app_name));
    ...
    private void initViews() {
        ...
        binding.imBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AppManage.getInstance(LikeeActivity.this).showInterstitialAd(LikeeActivity.this, new AppManage.MyCallback() {
                    public void callbackCall() {
                        Intent intent = new Intent(LikeeActivity.this, StatusSaverOfAllAppActivity.class);
