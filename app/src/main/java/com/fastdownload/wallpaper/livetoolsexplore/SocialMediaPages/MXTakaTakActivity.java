...
import static com.fastdownload.wallpaper.livetoolsexplore.utils.Utils.ROOTDIRECTORYMX;
...
public class MXTakaTakActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(MXTakaTakActivity.this).loadInterstitialAd(this);
        AppManage.getInstance(MXTakaTakActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);
        setLocale(appLangSessionManager.getLanguage());
        commonClassForAPI = CommonClassForAPI.getInstance(activity);
        createFileFolder();
        initViews();

        binding.imAppIcon.setImageDrawable(getResources().getDrawable(R.drawable.takatak_icon));
        binding.tvAppName.setText(getResources().getString(R.string.mxtakatak_app_name));
        binding.appName.setText(getResources().getString(R.string.mxtakatak_app_name));
    ...
    private void initViews() {
        ...
        binding.imBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AppManage.getInstance(MXTakaTakActivity.this).showInterstitialAd(MXTakaTakActivity.this, new AppManage.MyCallback() {
                    public void callbackCall() {
                        Intent intent = new Intent(MXTakaTakActivity.this, StatusSaverOfAllAppActivity.class);
