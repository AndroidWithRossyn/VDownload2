...
import static com.fastdownload.wallpaper.livetoolsexplore.utils.Utils.RootDirectorySnackVideo;
...
public class SnackVideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity = this;
        AppManage.getInstance(SnackVideoActivity.this).loadInterstitialAd(this);
        AppManage.getInstance(SnackVideoActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);
        commonClassForAPI = CommonClassForAPI.getInstance(activity);
        createFileFolder();
        initViews();

        binding.imAppIcon.setImageDrawable(getResources().getDrawable(R.drawable.snack_video_icon));
        binding.tvAppName.setText(getResources().getString(R.string.snack_app_name));
        binding.appName.setText(getResources().getString(R.string.snack_app_name));
    ...
    private void initViews() {
        ...
        binding.imBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AppManage.getInstance(SnackVideoActivity.this).showInterstitialAd(SnackVideoActivity.this, new AppManage.MyCallback() {
                    public void callbackCall() {
                        Intent intent = new Intent(SnackVideoActivity.this, StatusSaverOfAllAppActivity.class);
