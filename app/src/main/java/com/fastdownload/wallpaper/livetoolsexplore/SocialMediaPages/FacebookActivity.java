...
import static com.fastdownload.wallpaper.livetoolsexplore.utils.Utils.RootDirectoryFacebook;
...
import com.fastdownload.wallpaper.livetoolsexplore.activity.FBLoginActivity;
import com.fastdownload.wallpaper.livetoolsexplore.activity.StatusSaverOfAllAppActivity;
import com.fastdownload.wallpaper.livetoolsexplore.adapter.FBStoriesListAdapter;
import com.fastdownload.wallpaper.livetoolsexplore.adapter.FbStoryUserListAdapter;
...
import com.fastdownload.wallpaper.livetoolsexplore.model.FBStoryModel.EdgesModel;
import com.fastdownload.wallpaper.livetoolsexplore.model.FBStoryModel.MediaModel;
...
public class FacebookActivity extends AppCompatActivity implements UserListInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activity = this;
        AppManage.getInstance(FacebookActivity.this).loadInterstitialAd(this);
        AppManage.getInstance(FacebookActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);
    ...
    private void initViews() {
        ...
        binding.TVTitle.setImageResource(R.drawable.facebook_icon);
        binding.tvLoginInstagram.setText(getResources().getString(R.string.download_stories));
        binding.imBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AppManage.getInstance(FacebookActivity.this).showInterstitialAd(FacebookActivity.this, new AppManage.MyCallback() {
                    public void callbackCall() {
                        Intent intent = new Intent(FacebookActivity.this, StatusSaverOfAllAppActivity.class);
    ...
    private void pasteText() {
        try {
            ...
            copyIntent = StatusSaverOfAllAppActivity.extractLinks(copyIntent);
