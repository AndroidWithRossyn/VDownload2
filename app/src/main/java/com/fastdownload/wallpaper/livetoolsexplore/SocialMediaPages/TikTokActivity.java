...
import static com.fastdownload.wallpaper.livetoolsexplore.utils.Utils.RootDirectoryTikTok;
...
public class TikTokActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(TikTokActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);
