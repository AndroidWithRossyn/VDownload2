...
import static com.fastdownload.wallpaper.livetoolsexplore.utils.Utils.RootDirectoryRoposo;
...
public class ReposeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppManage.getInstance(ReposeActivity.this).showNative((ViewGroup) findViewById(R.id.native_ads), ADMOB_N[0], FACEBOOK_N[0]);
