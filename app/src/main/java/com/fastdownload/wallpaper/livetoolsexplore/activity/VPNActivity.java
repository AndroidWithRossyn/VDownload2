...
import com.fastdownload.wallpaper.livetoolsexplore.Country_Code;
import com.fastdownload.wallpaper.livetoolsexplore.R;
import com.fastdownload.wallpaper.livetoolsexplore.RegionChooserDialog;
import com.fastdownload.wallpaper.livetoolsexplore.SharePreferencess;
import com.fastdownload.wallpaper.livetoolsexplore.Utilss;
...
public class VPNActivity extends AppCompatActivity implements RegionChooserDialog.RegionChooserInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        android.graphics.drawable.Drawable background = VPNActivity.this.getResources().getDrawable(R.drawable.gradient_theme);
        ...
        UnifiedSDK.getVpnState(new Callback<VPNState>() {
            ...
            public void success(@NonNull VPNState vpnState) {
                if (vpnState == VPNState.CONNECTED) {
                    Intent intent = new Intent(VPNActivity.this, DashboardActivity.class);
