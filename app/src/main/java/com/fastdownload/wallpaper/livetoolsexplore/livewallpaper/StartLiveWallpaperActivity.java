...
public class StartLiveWallpaperActivity extends AppCompatActivity {

    public static final String TAG = StartLiveWallpaperActivity.class.getSimpleName();
    private boolean intro;
    private WallpaperManager manager;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_start_live_wallpaper);
        ...
        if (savedInstanceState == null) {
            if (manager.getWallpaperInfo() == null ||
                ...
                getSupportFragmentManager()
                        .beginTransaction()
                        .replace(R.id.container, new NewHomeFragment())
                        .commit();
                intro = false;
            }
        }
